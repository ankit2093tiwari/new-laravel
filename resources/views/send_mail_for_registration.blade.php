<?php
    $username = base64_encode($details['email']);
    $password = base64_encode($details['password']);
    $full_url = $details['url']."authenticate".'/'.$username.'/'.$password;
?>
...
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"><strong><span style="font-size:18px;color:#aa67cf;">Thank you for joining Diligent Dollar !</span></strong></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"> </p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Diligent Dollar is much more than just a chore app!</span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">It's features help your kids gain valuable hands-on experience for managing money.</span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Our app is easy to use and will motivate your children to save, share, and spend their allowance. They can even learn about investing from inside the app.</span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"> </p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">To get started, Please click the link below to complete your registration with us -</span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"> </p>

<p style="margin: 0; text-align: center; mso-line-height-alt: 27px;"> <a href="{{ $full_url }}" style="color: #ffffff; background: #eeff41; text-transform: uppercase; font-size: 17px; width: 114px; display: inline-block; border-radius: 8px; text-decoration: none; padding: 8px 30px 10px 31px;">
                    login
                </a> </p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"> </p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Have any questions regarding Diligent Dollar? Write to us on help@diligentdollar.com </span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 18px;"> </p>
