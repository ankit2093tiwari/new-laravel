...
if(isset($details['section']) && $details['section'] == "update_username")
{
    $section = "User Name";
} else { $section = "Password"; }

if(isset($details['device_info']) && $details['device_info'] != '')
{
    $device_info = $details['device_info'];
} else { $device_info = ""; }

if(isset($details['location_info']) && $details['location_info'] != '')
{
    $location_info = $details['location_info'];
} else { $location_info = ""; }

if(isset($details['created_at']) && $details['created_at'] != '')
{
    $created_at = $details['created_at'];
    //$created_at = $get_device_location_info->created_at;

    $date_and_time = explode(' ',$created_at);
    $date = $date_and_time[0];
    $time = $date_and_time[1];
    $get_data_with_am_pm =  date('h:i A', strtotime($created_at));

    $gat_day_name = date('D', strtotime($date));
    $gat_month_name = date('M', strtotime($date));

    $gat_only_date_value = explode('-',$date);
    $only_date = $gat_only_date_value[2];

    $fill_value = $gat_day_name.','.$gat_month_name.','.$gat_only_date_value[2].','.$gat_only_date_value[0].','.$get_data_with_am_pm;
    //print_r($fill_value);

} else { $created_at = ""; $fill_value = ""; }
...
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #000000; background-image: none; background-position: top left; background-size: auto; background-repeat: no-repeat;" width="100%">
<tbody>
<tr>
<td>
...
<tr>
    <?php
        //$img1 = public_path()."/email_template_image/yourlogopassword.png";
    ?>
{{-- <td class="pad" style="padding-bottom:15px;padding-top:15px;width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img alt="your logo" src="<?php echo $message->embed($img1); ?>" style="display: block; height: auto; border: 0; width: 195px; max-width: 100%;" title="your logo" width="195"/></div>
</td> --}}
</tr>
</table>
</td>
...
<h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 28px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Did you change your <?=$section;?> ?</strong></h1>
</td>
</tr>
</table>
...
<tr>
<td class="pad" style="padding-top:35px;text-align:center;width:100%;">
<h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 15px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">We noticed the <?=$section;?> for your Airbnd account was recently changed. If this was you, you can safely disregard this email</span></h1>
</td>
</tr>
</table>
<table border="0" cellpadding="20" cellspacing="0" class="divider_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad">
...
<div class="" style="font-size: 12px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2;">
<p style="margin: 0; text-align: left; mso-line-height-alt: 14.399999999999999px;"><span style="font-size:18px;"><strong><span style="color:#8412c0;">Changed <?=$section;?></span></strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><strong><span style="color:#8412c0;">When: </span></strong><span style="color:#8412c0;"><?=$fill_value;?></span></span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 24px;"><strong><span style="font-size:16px;"><span style="color:#8412c0;">Where: </span></span></strong><span style="font-size:16px;"><span style="color:#8412c0;"><?=$location_info;?></span></span></p>
<p style="margin: 0; text-align: left; mso-line-height-alt: 24px;"><span style="font-size:16px;"><span style="color:#8412c0;"><strong>Device Type: </strong><?=$device_info;?></span></span></p>
</div>
</div>
</td>
</tr>
</table>
<table border="0" cellpadding="20" cellspacing="0" class="divider_block block-7" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad">
<div align="center" class="alignment">
<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="80%">
...
<tr>
<td class="pad">
<div align="center" class="alignment"><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com" style="height:50px;width:295px;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#8412c0" fillcolor="#8412c0"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><![endif]--><a href="javascript:void(0)" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:red;border-radius:0px;width:auto;border-top:1px solid transparent;font-weight:400;border-right:1px solid transparent;border-bottom:1px solid transparent;border-left:1px solid transparent;padding-top:10px;padding-bottom:10px;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:40px;padding-right:40px;font-size:14px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 28px;">I didn't do this -- review my account</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
</td>
</tr>
</table>
<table border="0" cellpadding="20" cellspacing="0" class="divider_block block-9" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad">
<div align="center" class="alignment">
<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="80%">
...
<p style="margin: 0; font-size: 14px; text-align: center; margin-left: 40px; mso-line-height-alt: 16.8px;"><span style="font-size:12px;"><strong><span style="color:#aa67cf;"><span style="">Your account security : </span></span></strong><span style="color:#aa67cf;"><span style=""><a href="javascript:void(0);" style="color:red">Could be stronger</a></span></span></span></p>
<p style="margin: 0; margin-left: 135px; mso-line-height-alt: 14.399999999999999px;"><span style="font-size:12px;"><span style="color:#aa67cf;"><span style=""><strong>             We noted a few things that you can do</strong>. </span></span></span><a href="javascript:void(0);" style="color:red">Click hear to secure your account</a></p>
</div>
</div>
</td>
</tr>
