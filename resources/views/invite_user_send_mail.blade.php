...
<h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 26px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><strong><span class="tinyMce-placeholder">Hello <?php echo $name; ?></span></strong></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Welcome to Diligent Dollar</span><span style="font-size:18px;color:#aa67cf;">.</span></p>
</div>
</div>
</td>
</tr>
...
<td class="pad">
<div align="center" class="alignment">
	<a href="{{ $full_url }}" style="text-decoration:none;display:inline-block;color:#ffffff;
	background-color:#8412c0;border-radius:0px;width:auto;border-top:1px solid transparent;
	font-weight:400;border-right:1px solid transparent;border-bottom:1px solid transparent;
	border-left:1px solid transparent;padding-top:10px;padding-bottom:10px;
	font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;
	...
	<span style="padding-left:40px;padding-right:40px;font-size:14px;display:inline-block;letter-spacing:normal;">
		<span dir="ltr" style="word-break: break-word;"><span data-mce-style="" dir="ltr" style="line-height: 28px;">
