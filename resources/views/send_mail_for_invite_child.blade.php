...
if(isset($details['fullname']) && $details['fullname'] !='') {
    $fullname = $details['fullname'];
} else { $fullname = ""; }


$child_id = base64_encode($details['child_id']);
$user_type = base64_encode($details['user_type_id']);
...
<td class="pad">
    ...
    ?>
<div align="center" class="alignment" style="line-height:10px"><img alt="Forgot your password?" src="<?php echo $message->embed($img1); ?>" style="display: block; height: auto; border: 0; width: 130px; max-width: 100%;" title="Forgot your password?" width="130"/></div>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="heading_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad" style="padding-left:45px;padding-top:35px;text-align:center;width:100%;">
<h1 style="margin: 0; color: #8412c0; direction: ltr; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 22px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><strong>Welcome to Diligent Dollar</strong></h1>
</td>
</tr>
</table>
...
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Hello <?=$fullname;?></span></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: Arial, sans-serif">
<div class="" style="font-size: 12px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; mso-line-height-alt: 18px; color: #393d47; line-height: 1.5;">
<p style="margin: 0; text-align: left; mso-line-height-alt: 27px;"><span style="font-size:18px;color:#aa67cf;">Please accept your invitation by clicking on the button below</span></p>
</div>
</div>
</td>
</tr>
...
<div align="center" class="alignment">
    ...
    <a href="{{ url('childAcceptInvitation/'.$child_id.'/'.$user_type) }}" style="text-decoration:none;display:inline-block;color:#ffffff;
    background-color:#8412c0;border-radius:0px;width:auto;border-top:1px solid transparent;font-weight:400;
    border-right:1px solid transparent;border-bottom:1px solid transparent;border-left:1px solid transparent;
    padding-top:10px;padding-bottom:10px;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;
    font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank">
    <span style="padding-left:40px;padding-right:40px;font-size:14px;display:inline-block;letter-spacing:normal;">
        <span style="word-break:break-word;"><span data-mce-style="" style="line-height: 28px;">Accept Invitation</span></span></span>
    </a></div>
</td>
</tr>
</table>
